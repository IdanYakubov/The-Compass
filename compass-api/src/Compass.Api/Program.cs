...
using Compass.Application.Ventures;
using Compass.Infrastructure.Persistence;
using Compass.Infrastructure.Seeding;
...
builder.Services.AddDbContext<AppDbContext>(options =>
{
    if (!string.IsNullOrWhiteSpace(postgres))
        ...
        options.UseSqlite(builder.Configuration.GetConnectionString("Sqlite") ?? "Data Source=compass.db");
});
